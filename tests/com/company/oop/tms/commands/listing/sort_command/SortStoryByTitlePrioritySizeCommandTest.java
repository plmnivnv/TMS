...
public class SortStoryByTitlePrioritySizeCommandTest {
    ...
    public void setup() {
        ...
        command = new SortStoryByTitlePrioritySizeCommand(repository);
    }
    ...
    @Test
    public void execute_Should_NotChangeListSizes_When_Sorted() {
