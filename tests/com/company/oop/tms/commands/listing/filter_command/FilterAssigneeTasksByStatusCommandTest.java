...
import com.company.oop.tms.commands.listings.filter_command.FilterAssigneeTasksByStatusCommand;
...
public class FilterAssigneeTasksByStatusCommandTest {
    ...
    public void setup(){
        ...
        command = new FilterAssigneeTasksByStatusCommand(systemRepository);
    }
