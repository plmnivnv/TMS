...
import com.company.oop.tms.commands.listings.filter_command.FilterBugByStatusCommand;
...
public class FilterBugByStatusCommandTest {
    ...
    public void setup(){
        ...
        command = new FilterBugByStatusCommand(systemRepository);
    }
