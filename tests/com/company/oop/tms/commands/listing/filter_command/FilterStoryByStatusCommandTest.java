...
import com.company.oop.tms.commands.listings.filter_command.FilterStoryByStatusCommand;
...
public class FilterStoryByStatusCommandTest {
    ...
    public void setup() {
        ...
        command = new FilterStoryByStatusCommand(systemRepository);
    }
